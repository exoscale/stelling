...
// HealthzResponse defines model for healthz-response.
...
type ServerInterface interface {
	// Healthz Simple ping healthcheck
	// (GET /healthz)
...
var swaggerSpec = []string{
	"ZJCxbuMwEER/xZi7Uifpzh2762KkSICUhguGXkt0KJJZroM4hv49WMpOilRccGcWM+8Cl6acIkUpMBcU",
	"N9Jk6ziSDTJ+/GEqOcVC+pc5ZWLxVBUTlWKHupBzJhgUYR8HzHMDpteTZ9rDbL+Eu+YmTM9HcoJZlT4e",
	"Ur3hJejuSSgEH4cVvdspB1r5KMTRhtX/xw0avBEXnyIM+vZv22NukDJFmz0M1m3frtEgWxlryO7aQ+eB",
	"RB/tYMWnuNnD4O6618hL0+r71/f6uBSFYrXZnIN31dgdiwa48dLpN9MBBr+6b6DdlWb3A2Xtvafi2GdZ",
	"ujzcV2zlNE2Wz4rB1/JZSSwH3EjuZfEWYsUAs73gxAEG3Y0S5t38GQAA//8=",
}
